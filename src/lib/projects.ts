...
export const projects: Project[] = [
  {
    id: "01",
    label: "Case Study 01",
    title: "Kevin Chiputra Newspaper — Personal Website",
    year: "2025",
    ...
    quote: '"Just try it and keep learning new skills and tools."',
    ...
    imageAlt: "Kevin Chiputra Newspaper — personal website screenshot",
    imageLeft: true,
  },
];
